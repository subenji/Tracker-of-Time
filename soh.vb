...
Module soh
    ...
    Public Sub sohSetup(ByVal startAddress As Int64)
        ...
        'frmTrackerOfTime.arrLocation(60) = SAV(&H36)
        'frmTrackerOfTime.arrLocation(61) = SAV(&HEB0)
        'frmTrackerOfTime.arrLocation(62) = SAV(&HEC4)
        'frmTrackerOfTime.arrLocation(63) = SAV(&HEC8)
        'frmTrackerOfTime.arrLocation(64) = SAV(&HECC)
        'frmTrackerOfTime.arrLocation(65) = SAV(&HED4)
        'frmTrackerOfTime.arrLocation(66) = SAV(&HED8)
        'frmTrackerOfTime.arrLocation(67) = SAV(&HEDC)
        'frmTrackerOfTime.arrLocation(68) = SAV(&HEE0)
        'frmTrackerOfTime.arrLocation(69) = SAV(&HEE4)
        'frmTrackerOfTime.arrLocation(70) = SAV(&HF08)
        'frmTrackerOfTime.arrLocation(71) = SAV(&HF0E)
        'frmTrackerOfTime.arrLocation(72) = SAV(&HF1A)
        'frmTrackerOfTime.arrLocation(73) = SAV(&H1288)
        'frmTrackerOfTime.arrLocation(74) = SAV(&H9E)
        'frmTrackerOfTime.arrLocation(75) = SAV(&H36)
        'frmTrackerOfTime.arrLocation(76) = SAV(&HA4)
        'frmTrackerOfTime.arrLocation(77) = SAV(&HA8)
        'frmTrackerOfTime.arrLocation(78) = SAV(&HE90)
        'frmTrackerOfTime.arrLocation(79) = SAV(&HE94)
        'frmTrackerOfTime.arrLocation(80) = SAV(&HE98)
        'frmTrackerOfTime.arrLocation(81) = SAV(&HE9C)
        'frmTrackerOfTime.arrLocation(82) = SAV(&HEA0)
        'frmTrackerOfTime.arrLocation(83) = SAV(&HEA4)
